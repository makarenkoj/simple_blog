module Posts
  class CreateFormComponent < RubyUI::Base
    attr_reader :post
    ...
    def view_template
      view_context.simple_form_for @post, builder: SimpleForm::FormBuilder, local: true, html: { multipart: true, class: 'space-y-6' } do |f|
