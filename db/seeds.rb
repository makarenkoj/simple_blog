...
if env['RAILS_ENV'] == 'development'
  puts "⚠️  You are running seeds in development environment. Make sure you have the right database configured!"
  ...
  puts "⚠️  You are running seeds in PRODUCTION environment. Be careful!"
end
